...
class CoreAutoPlay:
    ...
    def download_cover(self, url):
        ...
        :return:
        """
        self.main_window.network_manager.get(QNetworkRequest(QUrl(url)))
    ...
    def update_music_play_slider(self):
        ...
        self.main_window.music_play_slider.setMaximum(self.main_window.stacked_widget.currentWidget().music_play_status.music_data[self.main_window.stacked_widget.currentWidget().music_play_status.play_music_index].duration * 1000)
